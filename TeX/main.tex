...
\begin{figure}[!b]
	\centering
	\includesvg[inkscapelatex=false, width=0.50\linewidth]{diagrams/mnist-diagram.svg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{impact/mnist_change_5px.pdf}
        \caption{MNIST}
        \label{fig:impact_pixel_change_mnist}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{impact/cifar_change_5px_stuck.pdf}
        \caption{CIFAR-10}
...
\begin{figure}[!b]
    \centering
    \includegraphics[trim={0 1.25cm 0 0.5cm},clip,width=1\columnwidth]{impact/increasing_noise_example.pdf}
    \captionsetup{width=0.90\columnwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{impact/mnist_change_var_noise.pdf}
        \caption{MNIST}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{impact/cifar_change_var_noise.pdf}
        \caption{CIFAR-10}
    \end{subfigure}
    \captionsetup{width=0.90\columnwidth}
...
\begin{figure}[!t]
    \centering
    \includegraphics[trim={0 1.25cm 0 0.5cm},clip,width=1\columnwidth]{impact/increasing_blur_example.pdf}
    \captionsetup{width=0.90\columnwidth}
...
\begin{figure}[!b]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{impact/mnist_change_var_blur.pdf}
        \caption{MNIST}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{impact/cifar_change_var_blur.pdf}
        \caption{CIFAR-10}
    \end{subfigure}
    \captionsetup{width=0.90\columnwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        ...
        \includegraphics[width=\textwidth]{constant/mnist-pixel-stuck.pdf}
        \caption{Stuck} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        ...
        \includegraphics[width=\textwidth]{constant/cifar-pixel-stuck.pdf}
        \caption{Stuck} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{constant/mnist-pixel-hot.pdf}
        \caption{Hot} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{constant/cifar-pixel-hot.pdf}
        \caption{Hot} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{constant/mnist-pixel-dead.pdf}
        \caption{Dead} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{constant/cifar-pixel-dead.pdf}
        \caption{Dead} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{constant/mnist-noise-noise.pdf}
        \caption{} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{constant/cifar-noise-noise.pdf}
        \caption{} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{constant/mnist-blur-blur.pdf}
        \caption{} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{constant/cifar-blur-blur.pdf}
        \caption{} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{incremental/mnist-pixel-stuck.pdf}
        \caption{Stuck} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{incremental/cifar-pixel-stuck.pdf}
        \caption{Stuck} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{incremental/mnist-pixel-hot.pdf}
        \caption{Hot} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{incremental/cifar-pixel-hot.pdf}
        \caption{Hot} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{incremental/mnist-pixel-dead.pdf}
        \caption{Dead} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{incremental/cifar-pixel-dead.pdf}
        \caption{Dead} 
        \label{fig:incremental-cifar-dead}
    \end{subfigure}
    \captionsetup{width=0.80\linewidth}
    \caption{Incremental learning models trained on pixel variations for each pixel category. Results show tests on 2 px changes sampled 25 times for the MNIST and CIFAR-10 datasets.} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{incremental/mnist-noise-noise.pdf}
        \caption{} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{incremental/cifar-noise-noise.pdf}
        \caption{} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{incremental/mnist-blur-blur.pdf}
        \caption{} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{incremental/cifar-blur-blur.pdf}
        \caption{} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{transfer/mnist-pixel-stuck.pdf}
        \caption{Stuck} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{transfer/cifar-pixel-stuck.pdf}
        \caption{Stuck} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{transfer/mnist-pixel-hot.pdf}
        \caption{Hot} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{transfer/cifar-pixel-hot.pdf}
        \caption{Hot} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{transfer/mnist-pixel-dead.pdf}
        \caption{Dead} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{transfer/cifar-pixel-dead.pdf}
        \caption{Dead} 
        \label{fig:transfer-cifar-dead}
    \end{subfigure}
    \captionsetup{width=0.80\linewidth}
    \caption{Transfer learning models trained on pixel variations for each pixel category. Results show tests on 2 px changes sampled 25 times for the MNIST and CIFAR-10 datasets.} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{transfer/mnist-noise-noise.pdf}
        \caption{} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{transfer/cifar-noise-noise.pdf}
        \caption{} 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[h]{0.30\textwidth}
        \centering
        \textbf{MNIST}\par\medskip
        \includegraphics[width=\textwidth]{transfer/mnist-blur-blur.pdf}
        \caption{} 
    ...
    \begin{subfigure}[h]{0.30\textwidth}  
        \centering 
        \textbf{CIFAR-10}\par\medskip
        \includegraphics[width=\textwidth]{transfer/cifar-blur-blur.pdf}
        \caption{} 
