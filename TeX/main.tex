...
\begin{figure}[!b]
    \centering
    \includegraphics[trim={0 0.85cm 0 0.5cm},clip,width=1\columnwidth]{impact/increasing_noise_example.pdf}
    \captionsetup{width=0.90\columnwidth}
...
\begin{figure}[!t]
    \centering
    \includegraphics[trim={0 0.85cm 0 0.5cm},clip,width=1\columnwidth]{impact/increasing_blur_example.pdf}
    \captionsetup{width=0.90\columnwidth}
